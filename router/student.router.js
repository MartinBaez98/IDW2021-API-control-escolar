...
module.exports = () => {
    ...
    //busqueda por número de control
    ...
    //actualizar por número de control
    ...
    //contar mújeres y hombres por carrera
    router.post("/cantidadMH/", (req, res) => {
        Student.find({})
            .then((students) => {
                careers = {
    ...
    router.post("/listaAcreditados/", (req, res) => {
        Student.find({})
            .then((students) => {
                careers = {
    ...
    router.post("/listaMayores/", (req, res) => {
        Student.find({})
            .then((students) => {
                careers = {
